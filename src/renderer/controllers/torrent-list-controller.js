...
module.exports = class TorrentListController {
    ...
    showCreateTorrent(files) {
        ...
        findFilesRecursive(files, (allFiles) =>
            this.showCreateTorrent(allFiles)
        );
    }
    ...
    openTorrentContextMenu(infoHash) {
        ...
        menu.append(
            new electron.remote.MenuItem({
                ...
                click: () =>
                    electron.clipboard.writeText(torrentSummary.magnetURI),
            })
        );
        ...
        //         click: () =>
        //             dispatch('saveTorrentFileAs', torrentSummary.torrentKey),
        ...
        //         click: () =>
        //             dispatch('updatePreferences', 'sortByName', !sortedByName),
        //     })
        // );
