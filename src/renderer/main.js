...
const dispatchHandlers = {
    ...
    updateDownloadSpeedLimit: (speed) =>
        controllers.prefs().applyDownloadSpeedLimit(speed),
    updateUploadSpeedLimit: (speed) =>
        controllers.prefs().applyUploadSpeedLimit(speed),
...
function setupIpc() {
    ...
    ipcRenderer.on('wt-file-saved', (e, ...args) =>
        tc.torrentFileSaved(...args)
    );
...
function applySpeedLimits() {
    ...
    if (state.saved.prefs.uploadSpeedLimitEnabled) {
        ...
        controllers
            .prefs()
            .applyUploadSpeedLimit(state.saved.prefs.uploadSpeedLimit);
    }
    ...
    if (state.saved.prefs.downloadSpeedLimitEnabled) {
        ...
        controllers
            .prefs()
            .applyDownloadSpeedLimit(state.saved.prefs.downloadSpeedLimit);
    }
}
